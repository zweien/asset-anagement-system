...
router.post('/', editorMiddleware, AssetController.create)

// PUT /api/assets/:id - 更新资产 - 录入员及以上
router.put('/:id', editorMiddleware, AssetController.update)
...
router.post('/batch-delete', editorMiddleware, AssetController.batchDelete)
