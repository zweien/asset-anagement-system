import { r as reactExports, am as clsx, an as getDefaultExportFromCjs, ao as requireReact, ap as requireShim, a7 as reactDomExports, aq as React, u as useTranslation, b as useNavigate, g as assetApi, q as ASSET_STATUS_LABELS, ar as reportApi, p as fieldApi, j as jsxRuntimeExports } from "./index-qNrbFx48.js";
import { a as EmptyReports } from "./EmptyState-C7jBXoff.js";
...
var _excluded$n = ["children", "width", "height", "viewBox", "className", "style", "title", "desc"];
function _extends$s() {
...
var _excluded$l = ["type", "size", "sizeType"];
function _extends$q() {
...
var mapObject = (fn, obj) => Object.keys(obj).reduce((res, key) => _objectSpread$x(_objectSpread$x({}, res), {}, {
  [key]: fn(key, obj[key])
}), {});
...
var calStepperVals = (easing, preVals, steps) => {
  var nextStepVals = mapObject((key, val) => {
    if (needContinue(val)) {
      ...
      return _objectSpread$w(_objectSpread$w({}, val), {}, {
        from: newX,
        velocity: newV
      });
    }
...
function createStepperUpdate(from2, to2, easing, interKeys, render, timeoutController) {
  var preTime;
  var stepperStyle = interKeys.reduce((res, key) => _objectSpread$w(_objectSpread$w({}, res), {}, {
    [key]: {
      from: from2[key],
      velocity: 0,
      to: to2[key]
  ...
  var stepperUpdate = (now) => {
    ...
    render(_objectSpread$w(_objectSpread$w(_objectSpread$w({}, from2), to2), getCurrStyle()));
    preTime = now;
...
function createTimingUpdate(from2, to2, easing, duration, interKeys, render, timeoutController) {
  ...
  var timingStyle = interKeys.reduce((res, key) => {
    ...
    return _objectSpread$w(_objectSpread$w({}, res), {}, {
  ...
  var timingUpdate = (now) => {
    ...
    render(_objectSpread$w(_objectSpread$w(_objectSpread$w({}, from2), to2), currStyle));
    if (t < 1) {
      stopAnimation = timeoutController.setTimeout(timingUpdate);
    } else {
      var finalStyle = mapObject((key, val) => alpha(...val, easing(1)), timingStyle);
      render(_objectSpread$w(_objectSpread$w(_objectSpread$w({}, from2), to2), finalStyle));
    }
  };
  return () => {
    stopAnimation = timeoutController.setTimeout(timingUpdate);
...
const configUpdate = (from2, to2, easing, duration, render, timeoutController) => {
  ...
  if (easing == null) {
    return () => {
      render(_objectSpread$w(_objectSpread$w({}, from2), to2));
      return () => {
      };
    };
  }
...
var Rectangle = (rectangleProps) => {
  ...
  return /* @__PURE__ */ reactExports.createElement(JavascriptAnimate, {
    ...
    return /* @__PURE__ */ reactExports.createElement("path", _extends$l({}, otherPathProps2, {
      ...
      ref: pathRef,
      style: _objectSpread$v(_objectSpread$v({}, animationStyle), props.style)
    }));
  });
};
...
var inRangeOfSector = (_ref5, viewBox) => {
  ...
  if (inRange) {
    return _objectSpread$u(_objectSpread$u({}, viewBox), {}, {
      radius,
...
var selectAngleAxis = createSelector([selectAngleAxisNoDefaults, selectPolarChartLayout], (angleAxisSettings, layout) => {
  ...
  return _objectSpread$t(_objectSpread$t({}, implicitAngleAxis), {}, {
    type: evaluatedType
  });
});
...
var selectRadiusAxis = createSelector([selectRadiusAxisNoDefaults, selectPolarChartLayout], (radiusAxisSettings, layout) => {
  ...
  return _objectSpread$t(_objectSpread$t({}, implicitRadiusAxis), {}, {
    type: evaluatedType
  });
});
...
var selectAxisWithScale = createSelector(selectBaseAxis, selectAxisScale, (axis, scale) => {
  ...
  return _objectSpread$s(_objectSpread$s({}, axis), {}, {
    scale
  });
});
...
var combineTooltipInteractionState = (tooltipState, tooltipEventType, trigger, defaultIndex) => {
  ...
  if (hasBeenActivePreviously(appropriateMouseInteraction)) {
    if (activeFromProps) {
      return _objectSpread$r(_objectSpread$r({}, appropriateMouseInteraction), {}, {
        active: true
      });
    }
  ...
  return _objectSpread$r(_objectSpread$r({}, noInteraction), {}, {
  ...
  return tooltipPayloadConfigurations.reduce((agg, _ref2) => {
    ...
    if (Array.isArray(tooltipPayload)) {
      tooltipPayload.forEach((item) => {
        var newSettings = _objectSpread$q(_objectSpread$q({}, settings), {}, {
...
var useTooltipAxisBandSize = () => {
  ...
  return getBandSizeOfAxis(_objectSpread$p(_objectSpread$p({}, tooltipAxis), {}, {
...
var getActivePolarCoordinate = (layout, tooltipTicks, activeIndex, rangeObj) => {
  ...
  if (entry) {
    if (layout === "centric") {
      ...
      return _objectSpread$o(_objectSpread$o(_objectSpread$o({}, rangeObj), polarToCartesian(rangeObj.cx, rangeObj.cy, _radius, _angle)), {}, {
        angle: _angle,
        radius: _radius
      });
    }
    ...
    return _objectSpread$o(_objectSpread$o(_objectSpread$o({}, rangeObj), polarToCartesian(rangeObj.cx, rangeObj.cy, radius, angle)), {}, {
      angle,
      radius
    });
  }
...
var seed = {};
var initialState$9 = {
  zIndexMap: Object.values(DefaultZIndexes).reduce((acc, current2) => _objectSpread$n(_objectSpread$n({}, acc), {}, {
    [current2]: {
      element: void 0,
...
function CursorInternal(props) {
  ...
  var cursorProps = _objectSpread$m(_objectSpread$m(_objectSpread$m(_objectSpread$m({
    stroke: "#ccc",
    pointerEvents: "none"
    ...
    var listener2 = (incomingSyncId, action, emitter) => {
      ...
      if (syncMethod === "index") {
        ...
        if (viewBox && action !== null && action !== void 0 && (_action$payload = action.payload) !== null && _action$payload !== void 0 && _action$payload.coordinate && action.payload.sourceViewBox) {
          ...
          var scaledCoordinate = _objectSpread$l(_objectSpread$l({}, otherCoordinateProps), {}, {
            x: viewBox.x + (sourceWidth ? (_x - sourceX) / sourceWidth : 0) * viewBox.width,
            y: viewBox.y + (sourceHeight ? (_y - sourceY) / sourceHeight : 0) * viewBox.height
          });
          dispatch(_objectSpread$l(_objectSpread$l({}, action), {}, {
            payload: _objectSpread$l(_objectSpread$l({}, action.payload), {}, {
...
function Tooltip(outsideProps) {
  ...
  }, renderContent(content, _objectSpread$k(_objectSpread$k({}, props), {}, {
...
class LRUCache {
  constructor(maxSize) {
    _defineProperty$l(this, "cache", /* @__PURE__ */ new Map());
...
var currentConfig = _objectSpread$j({}, defaultConfig);
...
_defineProperty$j(DecimalCSS, "NaN", new _DecimalCSS(NaN, ""));
...
function Label(outerProps) {
  ...
  if (isPolar(viewBox)) {
    ...
    positionAttrs = _objectSpread$h(_objectSpread$h({
      x: cartesianResult.x,
      y: cartesianResult.y,
...
var _excluded$e = ["option", "shapeType", "activeClassName"];
...
var _excluded$b = ["axisLine", "width", "height", "className", "hide", "ticks", "axisType"];
...
function Reports() {
  ...
  const [customChartData, setCustomChartData] = reactExports.useState(null);
  ...
  const loadData = async () => {
    try {
      ...
      const statusArray = Object.entries(statusCount).filter(([, count]) => count > 0).map(([status, count]) => ({
        name: ASSET_STATUS_LABELS[status] || status,
        value: count,
      ...
      const monthCount = {};
      allAssets.forEach((asset) => {
        const date2 = new Date(asset.createdAt);
        const monthKey = `${date2.getFullYear()}-${String(date2.getMonth() + 1).padStart(2, "0")}`;
        monthCount[monthKey] = (monthCount[monthKey] || 0) + 1;
      });
      const monthArray = Object.entries(monthCount).sort(([a2], [b]) => a2.localeCompare(b)).slice(-6).map(([month, count]) => ({
  ...
  const loadTemplates = async () => {
    try {
      ...
      if (response.success) {
        ...
        const defaultTemplate = response.data.find((t2) => t2.isDefault);
        if (defaultTemplate) {
  ...
  const loadCustomReport = async (template) => {
    try {
      const response = await reportApi.getData({
        dimension: template.dimension,
        chartType: template.chartType,
        filters: template.filters || void 0,
        dateRange: template.dateRange || void 0,
        customStartDate: template.customStartDate || void 0,
        customEndDate: template.customEndDate || void 0
      });
      if (response.success) {
  ...
  const handleMonthlyChartClick = (data) => {
  ...
  const handleCustomChartClick = (data) => {
    const template = templates.find((t2) => t2.id === selectedTemplateId);
    if (!template) return;
    const filters = {};
  ...
  const handleExportReport = () => {
    ...
    link.href = url;
    link.download = `报表_${(/* @__PURE__ */ new Date()).toISOString().split("T")[0]}.csv`;
    link.click();
  ...
  const renderCustomChart = () => {
    if (!customChartData || customChartData.length === 0) {
      return /* @__PURE__ */ jsxRuntimeExports.jsx(EmptyReports, {});
    }
    const template = templates.find((t2) => t2.id === selectedTemplateId);
    ...
    switch (template?.chartType) {
      case "pie":
        return /* @__PURE__ */ jsxRuntimeExports.jsx(ResponsiveContainer, { width: "100%", height: 300, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(PieChart, { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            Pie,
            {
              ...
              children: chartData.map((entry, index) => /* @__PURE__ */ jsxRuntimeExports.jsx(Cell, { fill: entry.color }, `cell-${index}`))
            }
          ),
          /* @__PURE__ */ jsxRuntimeExports.jsx(Tooltip, {})
        ] }) });
      case "line":
        return /* @__PURE__ */ jsxRuntimeExports.jsx(ResponsiveContainer, { width: "100%", height: 300, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(LineChart, { data: chartData, children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(CartesianGrid, { strokeDasharray: "3 3", stroke: "#374151" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(XAxis, { dataKey: "label", stroke: "#9ca3af" }),
      ...
      default:
        return /* @__PURE__ */ jsxRuntimeExports.jsx(ResponsiveContainer, { width: "100%", height: 300, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(BarChart, { data: chartData, children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(CartesianGrid, { strokeDasharray: "3 3", stroke: "#374151" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(XAxis, { dataKey: "label", stroke: "#9ca3af" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(YAxis, { stroke: "#9ca3af" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
  ...
  if (loading) {
    return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex items-center justify-center h-64", children: /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-gray-500", children: t("common.loading") }) });
  }
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-6", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "text-2xl font-bold text-gray-900 dark:text-white", children: t("reports.title") }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-1 text-gray-500 dark:text-gray-400", children: t("reports.subtitle") })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-2 md:grid-cols-4 gap-4", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-white dark:bg-gray-900 rounded-xl shadow-sm border border-gray-200 dark:border-gray-800 p-4", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-gray-500 dark:text-gray-400", children: t("reports.totalAssets") }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-2xl font-bold text-gray-900 dark:text-white mt-1", children: total })
      ] }),
      statusData.map((item) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "div",
        {
          className: "bg-white dark:bg-gray-900 rounded-xl shadow-sm border border-gray-200 dark:border-gray-800 p-4",
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-gray-500 dark:text-gray-400", children: item.name }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-2xl font-bold mt-1", style: { color: item.color }, children: item.value })
          ]
        },
        item.name
      ))
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 lg:grid-cols-2 gap-6", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-white dark:bg-gray-900 rounded-xl shadow-sm border border-gray-200 dark:border-gray-800 p-6", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("h2", { className: "text-lg font-semibold text-gray-900 dark:text-white mb-4", children: [
          ...
          " ",
          /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-sm font-normal text-gray-500", children: [
            "(",
            t("reports.clickForDetails"),
            ")"
          ] })
        ] }),
        statusData.length > 0 ? /* @__PURE__ */ jsxRuntimeExports.jsx(ResponsiveContainer, { width: "100%", height: 300, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(PieChart, { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            Pie,
            {
              data: statusData,
              ...
              className: "cursor-pointer",
              children: statusData.map((entry, index) => /* @__PURE__ */ jsxRuntimeExports.jsx(Cell, { fill: entry.color }, `cell-${index}`))
            }
          ),
          /* @__PURE__ */ jsxRuntimeExports.jsx(Tooltip, {})
        ] }) }) : /* @__PURE__ */ jsxRuntimeExports.jsx(EmptyReports, {})
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-white dark:bg-gray-900 rounded-xl shadow-sm border border-gray-200 dark:border-gray-800 p-6", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("h2", { className: "text-lg font-semibold text-gray-900 dark:text-white mb-4", children: [
        ...
        monthlyData.length > 0 ? /* @__PURE__ */ jsxRuntimeExports.jsx(ResponsiveContainer, { width: "100%", height: 300, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(BarChart, { data: monthlyData, children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(CartesianGrid, { strokeDasharray: "3 3", stroke: "#374151" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(XAxis, { dataKey: "month", stroke: "#9ca3af" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(YAxis, { stroke: "#9ca3af" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            Tooltip,
            {
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-white dark:bg-gray-900 rounded-xl shadow-sm border border-gray-200 dark:border-gray-800 p-6", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between mb-4", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-lg font-semibold text-gray-900 dark:text-white", children: t("reports.customReport") }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-2", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "select",
            {
              ...
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: "", children: t("reports.selectTemplate") }),
      ...
      selectedTemplateId && customChartData ? /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-sm text-gray-500 dark:text-gray-400 mb-4", children: [
          ...
          ": ",
          getDimensionLabel(templates.find((t2) => t2.id === selectedTemplateId)?.dimension || "")
        ] }),
        renderCustomChart()
      ] }) : /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "h-64 flex items-center justify-center text-gray-500", children: templates.length > 0 ? t("reports.selectTemplatePrompt") : t("reports.createTemplatePrompt") })
    ] }),
    showTemplateModal && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-white dark:bg-gray-900 rounded-xl p-6 w-full max-w-md max-h-[90vh] overflow-y-auto", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "text-lg font-semibold text-gray-900 dark:text-white mb-4", children: editingTemplate ? t("reports.editTemplate") : t("reports.createTemplate") }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("label", { className: "block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1", children: t("reports.description") }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "input",
            {
              type: "text",
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "select",
            {
              ...
              className: "w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg bg-white dark:bg-gray-800 text-gray-900 dark:text-white",
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: "bar", children: t("reports.barChart") }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: "pie", children: t("reports.pieChart") }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: "line", children: t("reports.lineChart") })
              ]
            }
          )
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "select",
            {
              ...
              className: "w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg bg-white dark:bg-gray-800 text-gray-900 dark:text-white",
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: "status", children: t("reports.dimensionStatus") }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: "categoryId", children: t("reports.dimensionCategory") }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: "createdAt", children: t("reports.dimensionMonth") }),
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("label", { className: "block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1", children: t("reports.dateRange") }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "select",
            {
              ...
              className: "w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg bg-white dark:bg-gray-800 text-gray-900 dark:text-white",
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: "all", children: t("reports.rangeAll") }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: "today", children: t("reports.rangeToday") }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: "week", children: t("reports.rangeWeek") }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: "month", children: t("reports.rangeMonth") }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: "year", children: t("reports.rangeYear") }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: "custom", children: t("reports.rangeCustom") })
              ]
            }
          )
        ] }),
        formData.dateRange === "custom" && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-2 gap-4", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("label", { className: "block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1", children: t("reports.startDate") }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "input",
              {
                type: "date",
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("label", { className: "block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1", children: t("reports.endDate") }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "input",
              {
                type: "date",
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("label", { htmlFor: "isDefault", className: "ml-2 text-sm text-gray-700 dark:text-gray-300", children: t("reports.setAsDefault") })
        ] })
      ] }),
